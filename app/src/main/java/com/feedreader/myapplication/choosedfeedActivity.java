...
public class choosedfeedActivity extends AppCompatActivity {
    //String filePath;
    //File file;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.choosedfeed_layout);
        addButtonToLayout();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        finish();
        Intent intent = new Intent(this, com.feedreader.myapplication.MainActivity.class);
        startActivity(intent);
